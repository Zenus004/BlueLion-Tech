      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {categories.map((cat) => (
              <button
                ...
                className={`p-4 rounded-xl transition-all duration-300 ${selectedCategory === cat.id
        ...
        >
          <button
            ...
            className={`px-6 py-2 rounded-full font-semibold transition-all ${selectedDuration === 'threeMonths'
          ...
          <button
            ...
            className={`px-6 py-2 rounded-full font-semibold transition-all ${selectedDuration === 'sixMonths'
                ? 'bg-cyan-500 text-white'
                : 'bg-white/10 text-gray-300 hover:bg-white/20'
              }`}
          >
        ...
        >
          <button
            ...
            onClick={() => navigate(`/enroll?program=${encodeURIComponent(categories.find((c) => c.id === selectedCategory).name)}`)}
          >
